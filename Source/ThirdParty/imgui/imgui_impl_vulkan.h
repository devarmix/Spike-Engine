...
IMGUI_IMPL_API VkDescriptorSet  ImGui_ImplVulkan_CreateTextureDescSet();
IMGUI_IMPL_API void             ImGui_ImplVulkan_WriteTextureDescSet(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout, VkDescriptorSet descriptor_set);
