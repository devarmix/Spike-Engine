...
namespace Spike {
	...
	void GraphicsPipelineBuilder::SetShaders(VkShaderModule vertexShader, VkShaderModule fragmentShader) {
		...
		ShaderStages.push_back(
			VulkanUtils::PipelineShaderStageCreateInfo(VK_SHADER_STAGE_VERTEX_BIT, vertexShader, "VSMain"));

		ShaderStages.push_back(
			VulkanUtils::PipelineShaderStageCreateInfo(VK_SHADER_STAGE_FRAGMENT_BIT, fragmentShader, "PSMain"));
	}
	...
	void GraphicsPipelineBuilder::SetColorAttachments(const VkFormat* formats, uint32_t count) {
